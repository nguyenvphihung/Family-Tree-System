...
const MaternalGrandparentsStep: React.FC<MaternalGrandparentsStepProps> = ({ onNext, onSkip }) => {
  const [maternalGrandmother, setMaternalGrandmother] = useState<GrandparentFormData>({
    firstName: "",
    lastName: "",
    yearOfBirth: "",
    countryOfBirth: "",
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={maternalGrandmother.lastName}
                  onChange={(e) => setMaternalGrandmother({ ...maternalGrandmother, lastName: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
